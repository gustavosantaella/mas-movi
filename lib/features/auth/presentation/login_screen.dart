...
class _LoginScreenState extends ConsumerState<LoginScreen>
  ...
  void initState() {
    super.initState();
    _logoAnim = AnimationController(vsync: this, duration: const Duration(milliseconds: 600));
    _logoScale = Tween<double>(begin: 0.7, end: 1.0).animate(
      CurvedAnimation(parent: _logoAnim, curve: Curves.easeOutBack),
    );
          ...
          child: Column(
            children: [
              ...
              AnimatedBuilder(
                ...
                child: Image.asset('assets/images/guayaba-logo.png', height: 100),
              ),
              ...
              Align(
                ...
                child: GestureDetector(
                  ...
                  child: const Text(
                    ...
                    style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: AppColors.salmon),
                  ),
                ),
              ),
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color: _rememberMe ? AppColors.salmon : const Color(0xFFD1D5DB),
                          width: 1.5,
                        ),
                        color: _rememberMe ? AppColors.salmon : Colors.transparent,
                      ),
                      child: _rememberMe
                    ...
                    const Text(
                      'Recordarme',
                      style: TextStyle(fontSize: 13, color: AppColors.charcoal, fontWeight: FontWeight.w500),
                    ),
                  ],
                ),
              ),
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: const Text(
                      'Regístrate',
                      style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: AppColors.salmon),
                    ),
                  ),
                ],
              ),
